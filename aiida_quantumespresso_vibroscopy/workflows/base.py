...
from aiida_quantumespresso_vibroscopy.utils.validation import (
    validate_matrix, validate_positive, validate_tot_magnetization
)
from aiida_quantumespresso_vibroscopy.calculations.phonon_utils import get_energy, get_forces
from aiida_quantumespresso_vibroscopy.calculations.spectra_utils import get_supercells_for_hubbard
...
def validate_inputs(inputs, _):
    ...
    ensamble_inputs = [
        'structure',  'symprec', 'is_symmetry',
        'distinguish_kinds', 'primitive_matrix', 'supercell_matrix'
    ]
...
class BaseWorkChain(WorkChain):
    ...
    def define(cls, spec):
        ...
        spec.expose_inputs(PwBaseWorkChain, namespace='phonon_workchain.scf',
            namespace_options={
                'required': True,
        ...
        spec.expose_outputs(DielectricWorkChain,
            namespace_options={
                'required': False,
