...
from aiida_quantumespresso_vibroscopy.utils.elfield_cards_functions import get_vector_from_number, get_tuple_from_vector
...
def get_irreducible_numbers_and_signs(
    ...
    phonopy_instance = preprocess_data.get_phonopy_instance()
    irr_numbers = [i for i in range(number_id)]
