# -*- coding: utf-8 -*-
"""Defines a `Parser` base class for `aiida-vibroscopy`."""
# All `Parser` implementations in `aiida-vibroscopy` must use this base class, not `aiida.parsers.Parser`.
...
class Parser(_BaseParser):  # pylint: disable=abstract-method
    """Custom `Parser` class for `aiida-vibroscopy` parser implementations."""
