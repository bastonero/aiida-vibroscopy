...
# from aiida_vibroscopy.calculations.elph import ElPhCalculation
...
#         try:
#             # Check for job completion, indicating that phonopy exited without
#             # interruption, even if there was an error.
