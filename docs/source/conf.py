...
project = 'aiida-quantumespresso-vibroscopy'
copyright = '2022-{}, UNIVERSITY OF BREMEN (U Bremen Excellence Chair and MAPEX), Germany. All rights reserved'.format(
...
intersphinx_mapping = {
    ...
    'aiida_quantumespresso': ('http://aiida_quantumespresso.readthedocs.io/en/latest/', None),
}
...
html_use_opensearch = 'http://aiida-quantumespresso-vibroscopy.readthedocs.io'
...
htmlhelp_basename = 'aiida-quantumespresso-vibroscopydoc'
