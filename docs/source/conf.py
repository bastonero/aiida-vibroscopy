...
autoapi_ignore = [filepath_src / 'aiida_vibroscopy' / '*cli*']
...
html_use_opensearch = 'http://aiida-vibroscopy.readthedocs.io'
...
htmlhelp_basename = 'aiida-vibroscopydoc'
